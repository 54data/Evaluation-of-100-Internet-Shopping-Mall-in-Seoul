...
2. 연도별 데이터 분석(2019-2020)
    ...
    **1) 2019년도 〈서울시 인터넷 쇼핑몰 100개 평가 정보〉 분석**
    ...
    <div align = "center">쇼핑몰구분별 전체평가 평균점수는 ‘화장품’이 평균 83.65점으로 가장 높았고, ‘도서’(평균 83.48점)와 ‘식품’(평균 83.21점)이 뒤를 이었다.</br>반면 ‘해외구매대행’(평균 76.22점)과 ‘해외숙박예약’(평균 75.31점)은 낮은 점수를 받아 개선이 필요한 것으로 나타났다.</br>
    </div>
